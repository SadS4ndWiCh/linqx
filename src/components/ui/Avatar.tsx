...
Root.displayName = AvatarPrimivite.Root.displayName;
...
Image.displayName = AvatarPrimivite.Image.displayName;
...
Fallback.displayName = AvatarPrimivite.Fallback.displayName;